...
class RouteListener implements ListenerInterface
{
    ...
    {
        /* @var $configCollection \ZfAnnotation\Config\Collection */
    ...
    {
        $method = $method ? : 'index';
        $annotation = $this->autodetectMissingFields($annotation, $method, $class->getName());
    ...
    protected function autodetectMissingFields(Route $annotation, $method, $controllerClass)
    {
